...
export default class EditActivity extends Component {
  ...
  deleteEvent() {
    ...
    fetch('https://forums.swirlclinic.com:1337/api/activities/delete', {
      method: 'POST',
      headers: {
    ...
    .then((response) => response.json())
      .then((responseJson) => {
        ...
        if(responseJson.message == "Failure!") {
                          ...
                          alert('Successfully removed activity!');
  ...
  editEvent() {
    ...
    fetch('https://forums.swirlclinic.com:1337/api/activities/edit', {
      method: 'POST',
      headers: {
      'Accept': 'application/json',
      'Content-Type': 'application/json'
      ...
      return(
        <View style={{flex: 1, }}>
          ...
          <KeyboardAwareScrollView>
            <TableView>
              <Section>
                 <CellName title="Activity Name: " placeholder={this.props.event.name} defaultValue={this.props.event.name} />
          ...
          onPress={this.deleteEvent.bind(this)} >
            ...
            <Text style={{fontWeight: 'bold'}}>Delete Activity</Text>
        </TouchableOpacity>
            </TableView>
          </KeyboardAwareScrollView>
        </View>
